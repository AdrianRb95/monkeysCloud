...
import "./style.scss";
const MenuSettings = forwardRef((props, ref) => {
  return (
    <nav className="menuConfig" style={{ zIndex: 4 }} ref={ref}>
      <h1>Settings</h1>
      ...
      <div className="boxes">
        ...
        <span className="contenedor">
          ...
          <span className="descriptions">
            Add user,groups,and manage access request
          </span>
        </span>
      </div>
      ...
      <div className="boxes">
        ...
        <span className="contenedor">
          ...
          <span className="descriptions">
            Update your billing details ,manage your subscriptions
          </span>
        </span>
